 ...
 * buttonOnclick.  If your module supports the basic and touch pagetypes you 
 * must provide a buttonURL and make sure that any onclick Javascript is not 
 * necessary for the link to work.  
 *}
