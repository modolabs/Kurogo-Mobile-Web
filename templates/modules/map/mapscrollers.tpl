<div id="mapscrollers">
  <div id="nw">
    <a href="#" onclick="scrollMap(1,-1); scrollTo(0,1); return false">
      <img src="/common/images/blank.png" width="50" height="50" alt="NW" />
    </a>
  </div>
  <div id="n">
    <a href="#" onclick="scrollMap(1,0); scrollTo(0,1); return false">
  ...
  <div id="e">
    <a href="#" onclick="scrollMap(0,1); scrollTo(0,1); return false">
