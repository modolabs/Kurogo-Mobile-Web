...
<title>Harvard University Mobile Internet</title>
<link type="text/css" href="{$minify['css']}" rel="stylesheet" />
<link rel="shortcut icon" href="/favicon.ico" />
<meta name="description" http-equiv="description" content="Harvard University is launching a university-wide mobile initiative to aggregate and deliver useful, usable, mobile-appropriate content to the Harvard community, locally and worldwide. " />
</head>
...
<div id="container">
  ...
  <div id="footer">
  	<span class="copyright">&copy; 2010 <a href="http://www.harvard.edu" target="_blank">The President and Fellows of Harvard College</a></span><!--/copyright-- 
  </div><!--/footer-->
