...
// TODO: find a way to share these three lines with GoogleJSMap
    ...
    */
    ...
    mapControls.setup({
        ...
        locationUpdated: function(location, firstLocation) {
            ...
            apiRequest(apiURL + '/projectPoint', params, function(response) {
                ...
                if (typeof userLocationMarker == 'undefined') {
                    ...
                    var pointSymbol = new esri.symbol.PictureMarkerSymbol(fullURLPrefix + 'modules/map/images/map-location@2x.png', 16, 16);
